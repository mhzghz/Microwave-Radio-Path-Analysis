...
<tr><td align="right"><b>Equipment Model / Notes</b></td>
<td><input type="text" name="tx_notes" size="30" value=""></tr>

<tr><td align="right"><b>Site Latitude</b></td>
...
<input type="radio" name="LAT1_val" value="South">&nbsp;South&nbsp;&nbsp;(WGS84)</td></tr>

<tr><td align="right"><b>Site Longitude</b></td>
...
<input type="radio" name="LON1_val" value="East">&nbsp;East&nbsp;&nbsp;(WGS84)</td></tr>

<tr><td align="right"><b>Highest Transmitted Frequency</b></td>
<td><input type="text" name="frq" size="5" value="2467">
<select name="frq_val">
<option selected>MHz</option>
<option>GHz</option>
</select></td>
<td>20 MHz to 20 GHz</td></tr>

<tr><td align="right" bgcolor="#BABBBE"><b>Diversity Frequency</b></td>
<td bgcolor="#BABBBE"><input type="text" name="frq_div" size="5" value="0">
<select name="frq_div_val">
<option selected>MHz</option>
<option>GHz</option>
</select></td>
<td bgcolor="#BABBBE">Leave "0" if unused</td></tr>

<tr><td align="right"><b>RF Power Output</b></td>
...
<tr><td align="right"><b>External Transmission Line Type</b></td>
...
<tr><td bgcolor="#BABBBE" align="right"><b>If </b><font color="maroon">Other</font><b>, Enter Transmission Line Loss Specification</b></td>
...
<input type="radio" name="check1" value="meters">&nbsp;per 100 meters</td></tr>

<tr><td align="right"><b>External Transmission Line Length</b></td>
...
<tr><td align="right"><b>Antenna Height (Center-of-Radiation)</b></td>
...
<tr><td align="right"><b>Antenna Model / Notes</b></td>
<td><input type="text" name="tx_ant_notes" size="30" value="Conifer 24 dBi">
<td></td></tr>

<tr><td align="right"><b>Miscellaneous Transmission Line Losses</b></td>
...
<tr><td align="right"><b>Miscellaneous Gains, After Line/Misc. Loss</b></td>
...
<tr><td align="right"><b>Miscellaneous Path Losses</b></td>
...
<tr><td align="right"><b>Equipment Model / Notes</b></td>
<td><input type="text" name="rx_notes" size="30" value=""></tr>
...
<input type="radio" name="LAT2_val" value="South">&nbsp;South&nbsp;&nbsp;(WGS84)</td></tr>
...
<input type="radio" name="LON2_val" value="East">&nbsp;East</td></tr>

<tr><td align="right"><b>Receiver Transmission Line Type</b></td>
...
<input type="radio" name="check2" value="meters">&nbsp;per 100 meters</td></tr>
...
<option>Standby switches</option></select></td></tr>

<tr><td align="right"><b>Miscellaneous Gains, Before Line/Misc. Loss</b></td>
...
<tr><td align="right"><b>Receiver Threshold</b></td>
...
<tr><td bgcolor="#CCBBBB" align="right"><b>Diversity Antenna Spacing (Center-of-Radiation)</b></td>
...
<tr><td bgcolor="#CCCCBB" align="right">Following <font color="maroon">THREE</font> questions are for Digital Data systems <i>ONLY</i></td>
...
<tr><td bgcolor="#BABBBE" align="right"><b>If </b><font color="maroon">No</font><b>, Select the Effective Earth Radius, K-Factor</b></td>
...
<td bgcolor="#BABBBE">(Note 6)</td></tr>

<tr><td bgcolor="#BBCCBB"align="right">If <font color="maroon">Yes</font>, answer the following <font color="maroon">THREE</font> questions</td>
<td bgcolor="#BBCCBB">&nbsp;&nbsp;&#8628;</td>
<td bgcolor="#BBCCBB"></td></tr>

<tr><td bgcolor="#BBCCBB" align="right"><b>General Site Elevation</b></td>
<td bgcolor="#BBCCBB"><input type="number" name="k_ht" min="0" max="9999" value="0" step="1">
<select name="k_ht_val">
<option selected>feet</option>
<option>meters</option></select>
<td bgcolor="#BBCCBB">Above Mean Sea Level</td></tr>

<tr><td bgcolor="#BBCCBB" align="right"><b>Average Annual Relative Humidity</b></td>
<td bgcolor="#BBCCBB"><input type="number" name="rh" min="1" max="99" value="76" step="1"> percent</td>
<td bgcolor="#BBCCBB">(Note 7)</td></tr>

<tr><td bgcolor="#BBCCBB" align="right"><b>Average Annual Barometric Pressure</b></td>
<td bgcolor="#BBCCBB"><input type="number" name="baro" min="1.0" max="99.0" value="30.0" step="0.1"> inches of mercury</td>
<td bgcolor="#BBCCBB">(Note 8)</td></tr>
<tr><td></td></tr>

<tr><td align="right"><b>Would You Like to Calculate the Vigants-Barnett Climate Factor?</b></td>
<td><input type="radio" name="check4" value="yes">Yes&nbsp;&nbsp;
<input type="radio" name="check4" value="no" checked>No</td>
<td>(Note 9)</td></tr>

<tr><td bgcolor="#BABBBE" align="right"><b>If </b><font color="maroon">No</font><b>, Choose the Vigants-Barnett (Outage) Climate Factor</b></td>
...
<td bgcolor="#BABBBE"></td></tr>

<tr><td bgcolor="#A3A3A3" align="right">If <font color="maroon">Yes</font>, answer the following <font color="maroon">TWO</font> questions</td>
<td bgcolor="#A3A3A3">&nbsp;&nbsp;&#8628;</td>
<td bgcolor="#A3A3A3"></td></tr>

<tr><td bgcolor="#A3A3A3" align="right"><b>Average Terrain Roughness</b></td>
<td bgcolor="#A3A3A3"><input type="number" name="rough" min="0" max="140" value="0" step="1">
<select name="rough_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#A3A3A3">(Note 10)</td></tr>

<tr><td bgcolor="#A3A3A3" align="right"><b>Local Area Humidity Type</b></td>
...
<tr><td align="right"><b><a href="../pics/Annual_Average_Temperature_Map.png">Average Annual Temperature</a></b></td>
...
<tr><td align="right"><b>Select the Crane Rain Region</b></td>
<td><select name="rain">
...
<td><a href="http://www.gbppr.net/splat/path.html">Rain Regions</a></td></tr>

<tr><td bgcolor="#BABBBE" align="right"><b>If</b> <font color="maroon">None</font><b>, Enter a (0.01%) Precipitation Rate</b></td>
<td bgcolor="#BABBBE"><input type="number" name="rate" min="1.0" max="199.9" value="37.0" step="0.1"> mm/hour</td>
<td bgcolor="#BABBBE">(Note 11)</td></tr>

<tr><td align="right"><b>Water Vapor Density</b></td>
<td><input type="number" name="wvd" min="1.0" max="99.0" value="7.5" step="0.1"> grams/m<sup>3</sup></td>
<td>Moderate Humidity</td></tr>

<tr><td align="right"><b>Percent Fresnel Zone to Calculate</b></td>
<td><input type="number" name="nth" min="10" max="400" value="60" step="10"> %
<td>(Note 12)</td></tr>

<tr><td align="right"><b>Select Your State for City and County Plotting</b></td>
<td><select name="geo">
<option>NONE</option>
<option>AK</option>
<option>AL</option>
...
<tr><td align="right"><b>Additional Ground Clutter</b></td>
...
<tr><td align="right"><b><a href="https://www.fcc.gov/sites/default/files/am_m3_usa_medium.png">Ground Conductivity</a></b></td>
...
<tr><td align="right"><b>Select the <a href="https://en.wikipedia.org/wiki/Longley%E2%80%93Rice_model">Longley-Rice</a> Climate Type</b></td>
...
<tr><td align="right"><b>Antenna Polarization</b></td>
...
<tr><td align="right"><b>Situation Variability (Confidence)</b></td>
<td><input type="number" name="sit" min="3" max="99" value="50"> %</td>
<td>(Note 19)</td></tr>

<tr><td align="right"><b>Time Variability (Reliability)</b></td>
...
<tr><td bgcolor="#BABBBE" align="right"><b>Use Additional Land Clutter Height Template?</b></td>
<td bgcolor="#BABBBE"><select name="land_clutter">
<option selected>No</option>
<option>Yes</option>
</select></td>
<td bgcolor="#BABBBE">(Note 22)</td></tr>

<tr><td bgcolor="#A3A3A3" align="right">If <font color="maroon">Yes</font>, fill in the clutter height template below</td>
<td bgcolor="#A3A3A3">&nbsp;&nbsp;&#8628;</td>
<td bgcolor="#A3A3A3"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Open Water</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_water" min="1.0" max="100.0" value="1.0" step="0.5">
<select name="ht_water_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Perennial Ice/Snow</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_ice" min="1.0" max="100.0" value="1.0" step="0.5">
<select name="ht_ice_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Developed, Low Intensity</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_devlow" min="1.0" max="100.0" value="15.0" step="0.5">
<select name="ht_devlow_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Developed, Medium Intensity</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_devmed" min="1.0" max="100.0" value="25.0" step="0.5">
<select name="ht_devmed_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Developed, High Intensity</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_devhgh" min="1.0" max="100.0" value="40.0" step="0.5">
<select name="ht_devhgh_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Developed, Open Space</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_devspc" min="1.0" max="100.0" value="6.0" step="0.5">
<select name="ht_devspc_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Barren Land (Rock/Sand/Clay)</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_barrn" min="1.0" max="100.0" value="1.5" step="0.5">
<select name="ht_barrn_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Deciduous Forest</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_dedfor" min="1.0" max="100.0" value="50.0" step="0.5">
<select name="ht_dedfor_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Evergreen Forest</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_evrfor" min="1.0" max="100.0" value="85.0" step="0.5">
<select name="ht_evrfor_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Mixed Forest</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_mxdfor" min="1.0" max="100.0" value="65.0" step="0.5">
<select name="ht_mxdfor_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Grassland/Herbaceous</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_grass" min="1.0" max="100.0" value="4.0" step="0.5">
<select name="ht_grass_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Shrub/Scrub</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_shrub" min="1.0" max="100.0" value="6.0" step="0.5">
<select name="ht_shrub_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Pasture/Hay</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_hay" min="1.0" max="100.0" value="2.0" step="0.5">
<select name="ht_hay_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Cultivated Crops</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_crop" min="1.0" max="100.0" value="3.0" step="0.5">
<select name="ht_crop_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Woody Wetlands</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_wood" min="1.0" max="100.0" value="12.0" step="0.5">
<select name="ht_wood_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>

<tr><td bgcolor="#8F7E97" align="right"><b>Emergent Herbaceous Wetland</b></td>
<td bgcolor="#8F7E97"><input type="number" name="ht_hrbwet" min="1.0" max="100.0" value="15.0" step="0.5">
<select name="ht_hrbwet_val">
<option selected>feet</option>
<option>meters</option>
</select></td>
<td bgcolor="#8F7E97"></td></tr>
...
<p><font color="red">Only Press <b>Submit</b> Once!</font><br>Press <b>Submit</b> to see an example.<br><i>It will take awhile for the plotting to complete.</i></p>
</center>
</form>
